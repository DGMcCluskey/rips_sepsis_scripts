...
## simpler analysis by looking at expression between survival groups and looking at outliers

```{r}
plot_df <- full_df[, c(1,3:11520,11564,11568,11571,11572)]
plot_df <- pivot_longer(plot_df, names_to = "gene", values_to = "expression", 2:11519)
names(plot_df)[4] <- "mortality_28d"
```